...
int main()
{
    ...
    while(t--)
    {
        ...
        if (n % 2 == 0)
        {
            oddPosition = evenPosition = n / 2;
            if (oddCount == evenCount)
                ans = n;
            else if (evenCount > oddPosition)
                ans = n - (evenCount - oddPosition);
            else
                ans = n - (oddCount - evenPosition);
        }
        else
        {
            oddPosition = (n / 2) + 1;
            evenPosition = n / 2;
            if (oddCount == evenPosition)
                ans = n;
            else if (evenCount > oddPosition)
                ans = n - (evenCount - oddPosition);
            else
